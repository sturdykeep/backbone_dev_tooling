...
import 'package:perfmon/core/backbone_worker.dart';
import 'package:perfmon/core/debouncer.dart';
import 'package:perfmon/core/debug_data_model.dart';
import 'package:perfmon/core/perfmon_data_mapper.dart';
...
import 'package:perfmon/widget/statistics.dart';
    ...
    if (subscription == null) {
      ...
      subscription = stream.listen((WebSocket webSocket) {
        ...
        webSocket.listen((data) {
          final event = PerfmonDataMapper.parse(data?.toString() ?? "");
          if (event != null) {
            for (final callback in dataHandler.callbacks) {
              callback.call(event);
            }
